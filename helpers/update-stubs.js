...
function generateValueSource(name, value, indent = 1) {
    switch (typeof value) {
        case "string":
            return getIndentedSource(generateStringSource(name, value), indent);
        case "object":
            return getIndentedSource(generateObjectSource(name, value), indent);
        default:
            return getIndentedSource(generateTypedSource(name, value), indent);
    }
}
